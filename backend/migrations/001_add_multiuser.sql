...
-- 2. Tested this script on a staging/dev environment
-- 3. Created an admin user via Supabase Auth dashboard
-- 4. Noted the admin user's UUID for use in this script
-- ============================================================================
...
DECLARE
  admin_user_id UUID;
  admin_email TEXT := 'REPLACE_WITH_YOUR_ADMIN_EMAIL@example.com'; -- ⚠️ CHANGE THIS
BEGIN
  RAISE NOTICE '';
...
-- Uncomment and run these commands ONLY if you need to rollback this migration
--
-- -- WARNING: This will remove all multi-user features
...
--
-- DROP POLICY IF EXISTS "Users can read own templates" ON public.indesign_templates;
-- DROP POLICY IF EXISTS "Users can insert own templates" ON public.indesign_templates;
-- DROP POLICY IF EXISTS "Users can update own templates" ON public.indesign_templates;
-- DROP POLICY IF EXISTS "Users can delete own templates" ON public.indesign_templates;
-- DROP POLICY IF EXISTS "Admins can read all templates" ON public.indesign_templates;
-- DROP POLICY IF EXISTS "Admins can insert templates" ON public.indesign_templates;
-- DROP POLICY IF EXISTS "Admins can update all templates" ON public.indesign_templates;
--
-- DROP POLICY IF EXISTS "Users can read own generations" ON public.magazine_generations;
-- DROP POLICY IF EXISTS "Users can insert own generations" ON public.magazine_generations;
-- DROP POLICY IF EXISTS "Users can update own generations" ON public.magazine_generations;
-- DROP POLICY IF EXISTS "Admins can read all generations" ON public.magazine_generations;
--
-- -- Disable RLS
-- ALTER TABLE public.profiles DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.subscriptions DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.usage_logs DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.indesign_templates DISABLE ROW LEVEL SECURITY;
-- ALTER TABLE public.magazine_generations DISABLE ROW LEVEL SECURITY;
--
-- -- Drop new tables
...
-- ALTER TABLE public.indesign_templates DROP COLUMN IF EXISTS user_id;
-- ALTER TABLE public.indesign_templates DROP COLUMN IF EXISTS visibility;
-- ALTER TABLE public.magazine_generations DROP COLUMN IF EXISTS user_id;
--
